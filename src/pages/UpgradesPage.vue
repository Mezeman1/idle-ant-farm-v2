        ...
        <div class="space-y-4">
          ...
          <div class="bg-purple-50 p-4 rounded-lg">
            ...
            <ul class="text-sm text-purple-800 list-disc pl-5 space-y-1">
              ...
              <li class="ml-4">1. Activity-based: Accumulate enough foraging trips to complete the cycle</li>
              <li class="ml-4">2. Food-based: Gather enough food to instantly complete a cycle</li>
