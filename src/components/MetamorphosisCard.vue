...
<template>
  <section :class="['bg-gradient-to-br from-purple-100 to-purple-50 rounded-xl p-2 sm:p-3 shadow-md', className]">
    ...
    <div class="space-y-1 sm:space-y-2">
      <div class="grid grid-cols-2 gap-1 sm:gap-2">
        <div class="bg-white/80 p-1.5 sm:p-2 rounded-lg shadow-sm border border-purple-200">
          <div class="text-2xs sm:text-xs text-purple-700 font-medium">
      ...
      <div class="bg-white/80 p-1.5 sm:p-2 rounded-lg shadow-sm border border-purple-200">
        <div class="text-2xs sm:text-xs text-purple-700 font-medium flex justify-between">
        ...
        <div class="h-1 sm:h-1.5 bg-purple-100 rounded-full mt-0.5 sm:mt-1 overflow-hidden">
        ...
        <div class="text-2xs sm:text-xs text-purple-600 mt-0.5 sm:mt-1">
      ...
      <div class="bg-white/80 p-1.5 sm:p-2 rounded-lg shadow-sm border border-purple-200">
        ...
        <div class="grid grid-cols-2 gap-1 mt-0.5 sm:mt-1">
          <div class="text-2xs sm:text-xs font-medium flex items-center">
            <span class="i-heroicons-clock text-purple-600 mr-0.5 sm:mr-1 text-2xs sm:text-xs"></span>
            {{ formatDecimal(prestigeStore.ticksPerLoop, 1) }}
            <span v-if="isSmallScreen">tr</span>
            <span v-else>trips</span>
          </div>
          <div class="text-2xs sm:text-xs font-medium flex items-center">
            <span class="i-heroicons-cake text-purple-600 mr-0.5 sm:mr-1 text-2xs sm:text-xs"></span>
      ...
      <router-link to="/upgrades"
        class="block w-full px-2 sm:px-3 py-1 sm:py-1.5 bg-purple-600 hover:bg-purple-700 text-white rounded-md text-2xs sm:text-xs font-medium text-center">
