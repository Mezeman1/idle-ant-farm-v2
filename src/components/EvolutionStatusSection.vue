...
<template>
  <section class="bg-gradient-to-br from-purple-200 to-purple-100 rounded-xl p-4 shadow-md border border-purple-300/50">
    <div class="flex flex-col space-y-3">
      <!-- Header with collapsible option -->
      <div class="flex items-center justify-between">
        <h2 class="text-base font-bold flex items-center text-purple-800">
        ...
        <div class="flex items-center space-x-2">
          <button @click="emit('toggleAboutEvolution')"
            class="w-6 h-6 rounded-full bg-purple-300 hover:bg-purple-400 flex items-center justify-center text-purple-800 transition-colors">
      ...
      <div class="grid grid-cols-3 gap-3">
        ...
        <div class="col-span-2 grid grid-cols-2 gap-3">
          <div class="bg-white/90 p-2 rounded-lg shadow-sm border border-purple-300">
            <div class="flex justify-between items-center">
              <div class="text-xs text-purple-800 font-medium">Evolution Points</div>
          ...
          <div class="bg-white/90 p-2 rounded-lg shadow-sm border border-purple-300">
            <div class="flex justify-between items-center">
              <div class="text-xs text-purple-800 font-medium">Metamorphosis</div>
              <div class="text-sm font-bold flex items-center">
          ...
          <div class="bg-white/90 p-2 rounded-lg shadow-sm border border-purple-300 col-span-2">
            <div class="flex justify-between items-center mb-1">
              <div class="text-xs text-purple-800 font-medium">Foraging Cycles</div>
          ...
          <div class="bg-white/90 p-2 rounded-lg shadow-sm border border-purple-300">
            <div class="flex justify-between items-center mb-1">
              <div class="text-xs text-purple-800 font-medium">Cycle Progress</div>
              <div class="text-xs text-purple-800">{{ loopProgressPercentage }}%</div>
            </div>
            <div class="h-2 bg-purple-100 rounded-full overflow-hidden">
              <div class="h-full bg-purple-600 transition-all duration-300 ease-out"
          ...
          <div class="bg-white/90 p-2 rounded-lg shadow-sm border border-purple-300">
            <div class="flex justify-between items-center mb-1">
              <div class="text-xs text-purple-800 font-medium">Food Progress</div>
              <div class="text-xs text-purple-800">{{ foodProgressPercentage }}%</div>
            </div>
            <div class="h-2 bg-purple-100 rounded-full overflow-hidden">
              <div class="h-full bg-purple-600 transition-all duration-300 ease-out"
        ...
        <!-- Right column: Metamorphose button and potential gain -->
        <div class="flex flex-col space-y-2">
          <div v-if="canEvolve" class="bg-white/90 p-2 rounded-lg shadow-sm border border-purple-300 flex-grow">
            <div class="text-xs text-purple-800 font-medium">Potential Gain</div>
            <div class="text-sm font-bold flex items-center text-purple-700">
              <span class="i-heroicons-sparkles text-purple-600 mr-1 text-xs"></span>
          ...
          <button @click="emit('confirmEvolution')"
            class="py-2 px-3 rounded-lg text-white font-bold transition-colors duration-200 flex items-center justify-center flex-grow"
            ...
            :disabled="!canEvolve">
            <span class="i-heroicons-sparkles text-base mr-1.5"></span>
            <span v-if="canEvolve">Metamorphose</span>
            <span v-else class="text-xs">Need {{ formattedRequiredLoops }} Cycles</span>
          </button>
        </div>
      </div>
    </div>
