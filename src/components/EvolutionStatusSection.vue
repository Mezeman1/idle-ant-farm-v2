...
<template>
  <section
    class="bg-gradient-to-br from-purple-200 to-purple-100 dark:from-purple-900/40 dark:to-purple-800/40 rounded-xl p-2 sm:p-4 shadow-md border border-purple-300/50 dark:border-purple-700/50 dark:text-purple-100">
    <div class="flex flex-col space-y-2 sm:space-y-3">
      <!-- Header with collapsible option -->
      <div class="flex items-center justify-between">
        <h2 class="text-sm sm:text-base font-bold flex items-center text-purple-800 dark:text-purple-200">
          <span class="i-heroicons-sparkles text-purple-700 dark:text-purple-400 mr-1 sm:mr-2"></span>
        ...
        <div class="flex items-center space-x-1 sm:space-x-2">
          <button @click="emit('toggleAboutEvolution')"
            class="w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-purple-300 dark:bg-purple-700 hover:bg-purple-400 dark:hover:bg-purple-600 flex items-center justify-center text-purple-800 dark:text-purple-200 transition-colors">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
        ...
        <div class="sm:col-span-2 grid grid-cols-2 gap-2 sm:gap-3">
          <div
            class="bg-white/90 dark:bg-gray-800/90 p-1.5 sm:p-2 rounded-lg shadow-sm border border-purple-300 dark:border-purple-700">
            <div class="flex justify-between items-center">
              <div class="text-2xs sm:text-xs text-purple-800 dark:text-purple-300 font-medium">
              ...
              <div class="text-xs sm:text-sm font-bold flex items-center">
                <span
                  class="i-heroicons-sparkles text-purple-600 dark:text-purple-400 mr-0.5 sm:mr-1 text-2xs sm:text-xs"></span>
          ...
          <div
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="text-xs sm:text-sm font-bold flex items-center">
                <span
                  class="i-heroicons-arrow-path text-purple-600 dark:text-purple-400 mr-0.5 sm:mr-1 text-2xs sm:text-xs"></span>
          ...
          <div
            class="bg-white/90 dark:bg-gray-800/90 p-1.5 sm:p-2 rounded-lg shadow-sm border border-purple-300 dark:border-purple-700 col-span-2">
        ...
        <div class="flex sm:flex-col space-x-2 sm:space-x-0 sm:space-y-2">
          <div v-if="canEvolve"
            class="bg-white/90 dark:bg-gray-800/90 p-1.5 sm:p-2 rounded-lg shadow-sm border border-purple-300 dark:border-purple-700 flex-grow">
            <div class="text-2xs sm:text-xs text-purple-800 dark:text-purple-300 font-medium">
              <span v-if="isSmallScreen">Potential</span>
              <span v-else>Potential Gain</span>
            </div>
            <div class="text-xs sm:text-sm font-bold flex items-center text-purple-700 dark:text-purple-400">
              <span
                class="i-heroicons-sparkles text-purple-600 dark:text-purple-400 mr-0.5 sm:mr-1 text-2xs sm:text-xs"></span>
          ...
          <button @click="emit('confirmEvolution')"
            ...
            :class="canEvolve ? 'bg-gradient-to-r from-purple-700 to-purple-600 hover:from-purple-800 hover:to-purple-700 dark:from-purple-800 dark:to-purple-700 dark:hover:from-purple-900 dark:hover:to-purple-800 shadow-lg' : 'bg-gray-300 dark:bg-gray-700 cursor-not-allowed'"
            :disabled="!canEvolve">
