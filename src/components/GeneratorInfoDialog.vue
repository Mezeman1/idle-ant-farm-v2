...
<template>
    <div v-if="show" class="fixed inset-0 z-50">
        ...
        <div class="fixed inset-0 flex flex-col animate-fadeIn" :class="{ 'animate-fadeOut': isClosing }">
            <div class="w-full h-full flex flex-col bg-amber-50 dark:bg-gray-900 text-amber-900 dark:text-amber-100 font-sans animate-slideUp"
                    ...
                    <div class="p-2 md:p-3">
                        ...
                        <div class="flex items-center justify-between">
                            <h1 class="text-lg md:text-xl font-bold tracking-tight flex items-center">
                                <span
                                    class="i-heroicons-information-circle text-amber-300 dark:text-amber-400 mr-2"></span>
                                About Ant Specialization
                            </h1>
                            <button @click="handleClose"
                                class="text-amber-50 hover:text-amber-300 dark:hover:text-amber-200 transition-colors p-1.5 rounded-full hover:bg-amber-900/30 dark:hover:bg-amber-950/40">
                ...
                <main class="flex-1 overflow-y-auto p-4 pb-6 scroll-smooth">
                    <div class="space-y-3">
                        <div
                            class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-amber-200 dark:border-amber-700 p-3">
                            <p class="text-sm text-amber-800 dark:text-amber-300 mb-2 font-medium">
                                How Ant Specialization Works:
                            </p>

                            <ul class="text-xs text-amber-800 dark:text-amber-300 list-disc pl-4 space-y-1">
